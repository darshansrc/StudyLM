...
export default function ChatWithFiles() {
  ...
  return (
    <div
      className="min-h-[100dvh] bg-zinc-900 w-full items-center  flex justify-center"
      onDragOver={(e) => {
        e.preventDefault();
        setIsDragging(true);
      }}
    ...
    >
      ...
      <Card className="w-full max-w-md bg-zinc-800 h-full border-0 sm:border sm:h-fit mt-12">
