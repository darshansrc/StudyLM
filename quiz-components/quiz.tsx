...
export default function Quiz({
  ...
  return (
    <div className="min-h-[100dvh] bg-zinc-900 w-full items-center  flex justify-center">
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-3xl font-bold mb-8 mt-20 text-center text-foreground">
          {title}
        </h1>
        <div className="py-4 min-h-16"></div>
